...
- **دو حالت FEC**
  - **Normal FEC** - تصحیح خطای استاندارد (16 بایت پریتی)
  - **Robust FEC** - بهبود یافته برای محیط‌های پر سر و صدا (32 بایت پریتی)
- **تشخیص خودکار** - گیرنده به صورت خودکار حالت انتقال و تنظیمات FEC را تشخیص می‌دهد
...
4. **Normal FEC** یا **Robust FEC** (برای محیط‌های پر سر و صدا) را انتخاب کنید
5. اختیاری: **رمزنگاری** را فعال کرده و رمز عبور وارد کنید
6. روی **ایجاد صدا** کلیک کنید
7. صدا را نزدیک دستگاه گیرنده پخش کنید
8. جمع کنترلی SHA-256 (و رمز عبور در صورت رمزنگاری) را با گیرنده به اشتراک بگذارید
...
### حالت Phone (300-3400 Hz)
| پارامتر | مقدار |
|---------|-------|
| مدولاسیون | 8-MFSK (3 بیت/سمبل) |
| محدوده فرکانس | 600 - 3050 Hz |
| مدت سمبل | 50ms + 8ms guard |
| نرخ بیت مؤثر | ~30-35 bps |

### حالت Wideband (HD Voice)
| پارامتر | مقدار |
|---------|-------|
...
| حالت | بایت‌های Parity | تصحیح خطا |
|------|-----------------|-----------|
| Normal FEC | 16 بایت | تا 8 خطا/فریم |
| Robust FEC | 32 بایت | تا 16 خطا/فریم |
...
|----------|------------|---------------|
| 100 بایت | ~30 ثانیه | ~20 ثانیه |
| 1 KB | ~4 دقیقه | ~2.5 دقیقه |
| 10 KB | ~40 دقیقه | ~25 دقیقه |

*زمان‌ها تقریبی هستند و شامل پیش‌آهنگ، هدرها و سربار FEC می‌شوند.*
...
5. **از Robust FEC استفاده کنید** - در شرایط پر سر و صدا یا تماس تلفنی
6. **جمع کنترلی را تأیید کنید** - همیشه SHA-256 را مقایسه کنید
