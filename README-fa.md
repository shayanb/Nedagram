...
| جزء | توضیح |
|-----|-------|
| تن گرم‌کننده | 200ms تن ثابت برای بیدار کردن مسیر صوتی |
| جارو چیرپ | 800ms جارو فرکانس بالا-پایین (600-2600 Hz) |
| فیلتر تطبیقی | تشخیص همبستگی متقاطع برای همگام‌سازی قوی |
| کالیبراسیون | 4 تن تکرار شده 2 بار برای کالیبراسیون سطح |
