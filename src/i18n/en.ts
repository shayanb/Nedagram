export const en = {
  ...
  help: {
    ...
    fecMode: 'Error Correction (Sender only)',
    fecModeNote: 'The receiver automatically detects which FEC mode was used.',
    normalFec: 'Normal FEC',
    normalFecDesc: 'Use in good audio conditions for faster transmission.',
    normalFecExamples: [
      'Quiet rooms',
      'Direct device-to-device',
      'Clear phone line',
    ],
    normalFecTradeoff: 'Corrects up to 8 byte errors per frame',
    robustFec: 'Robust FEC',
    robustFecDesc: 'Use in noisy environments or unreliable connections.',
    robustFecExamples: [
      'Outdoor or noisy spaces',
      'Poor phone signal',
      'Long distance',
      'Through speakers (not direct)',
    ],
    robustFecTradeoff: 'Corrects up to 16 byte errors per frame, but adds ~10% overhead',
